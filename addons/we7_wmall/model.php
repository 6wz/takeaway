...
function store_orderbys($language = '')
{
    ...
    return array( "distance" => array( "title" => language("离我最近" , [] , $language), "key" => "distance", "val" => "asc", "css" => "icon-b distance", "icon" => "location" ), "sailed" => array( "title" => language("销量最高" ,[] , $language), "key" => "sailed", "val" => "desc", "css" => "icon-b sailed-num", "icon" => "hot_light" ), "score" => array( "title" => language("评分最高" ,[] , $language), "key" => "score", "val" => "desc", "css" => "icon-b score", "icon" => "favor1" ), "send_price" => array( "title" => language("起送价最低",[] , $language), "key" => "send_price", "val" => "asc", "css" => "icon-b send-price", "icon" => "moneybag" ), "delivery_time" => array( "title" => language("送单速度最快",[] , $language), "key" => "delivery_time", "val" => "asc", "css" => "icon-b delivery-time", "icon" => "waimai" ) );
}
...
function store_discounts($language = '')
{
    ...
    $data = array("mallNewMember" => array("title" => language("首单立减",[] , $language), "key" => "mallNewMember", "val" => 1, "css" => "icon-b mallNewMember", "label" => "label-danger"), "newMember" => array("title" => language("新用户立减",[] , $language), "key" => "newMember", "val" => 1, "css" => "icon-b newMember", "label" => "label-danger"), "discount" => array("title" => language("立减优惠",[] , $language), "key" => "discount", "val" => 1, "css" => "icon-b discount", "label" => "label-danger"), "cashGrant" => array("title" => language("下单返现",[] , $language), "key" => "cashGrant", "val" => 1, "css" => "icon-b cashGrant", "label" => "label-success"), "grant" => array("title" => language("下单满赠",[] , $language), "key" => "grant", "val" => 1, "css" => "icon-b grant", "label" => "label-success"), "deliveryFeeDiscount" => array("title" => language("满减配送费",[] , $language), "key" => "deliveryFeeDiscount", "val" => 1, "css" => "icon-b deliveryFeeDiscount", "label" => "label-deliveryFeeDiscount"), "delivery_price" => array("title" => language("免配送费",[] , $language), "key" => "delivery_price", "val" => 0, "css" => "icon-b mian", "label" => "label-warning"), "bargain" => array("title" => language("特价优惠",[] , $language), "key" => "bargain", "val" => 1, "css" => "icon-b bargain", "label" => "label-primary"), "couponCollect" => array("title" => language("进店领券",[] , $language), "key" => "couponCollect", "val" => 1, "css" => "icon-b couponCollect", "label" => "label-success"), "couponGrant" => array("title" => language("下单返券",[] , $language), "key" => "couponGrant", "val" => 1, "css" => "icon-b couponGrant", "label" => "label-success"), "selfDelivery" => array("title" => language("自提优惠",[] , $language), "key" => "selfDelivery", "val" => 1, "css" => "icon-b selfDelivery", "label" => "label-warning"), "invoice_status" => array("title" => language("支持开发票",[] , $language), "key" => "invoice_status", "val" => 1, "css" => "icon-b invoice"), "svipRedpacket" => array("title" => language("会员领红包",[] , $language), "key" => "svipRedpacket", "val" => 1, "css" => "icon-b label-danger"));
    if (check_plugin_perm("zhunshibao"))
    {
        $data["zhunshibao"] = array( "title" => language("准时宝",[] , $language), "key" => "zhunshibao", "val" => 1, "css" => "icon-b label-danger" );
    }
...
function store_all_activity($language = '')
{
    ...
    return array( "mallNewMember" => array( "title" => language("平台新用户立减",[] , $language), "key" => "mallNewMember", "label" => "label-danger" ), "newMember" => array( "title" => language("门店新用户立减",[] , $language), "key" => "newMember", "label" => "label-danger" ), "discount" => array( "title" => language("满减优惠",[] , $language), "key" => "discount", "label" => "label-danger" ), "cashGrant" => array( "title" => language("下单返现",[] , $language), "key" => "cashGrant", "label" => "label-success" ), "grant" => array( "title" => language("下单满赠",[] , $language), "key" => "grant", "label" => "label-success" ), "bargain" => array( "title" => language("特价优惠",[] , $language), "key" => "bargain", "label" => "label-primary" ), "couponCollect" => array( "title" => language("进店领券",[] , $language), "key" => "couponCollect", "label" => "label-success" ), "couponGrant" => array( "title" => language("下单返券",[] , $language), "key" => "couponGrant", "label" => "label-success" ), "selfDelivery" => array( "title" => language("自提打折",[] , $language), "key" => "selfDelivery", "label" => "label-warning" ), "deliveryFeeDiscount" => array( "title" => language("满减配送费",[] , $language), "key" => "deliveryFeeDiscount", "label" => "label-warning" ), "selfPickup" => array( "title" => language("自提满减优惠",[] , $language), "key" => "selfPickup", "label" => "label-success" ), "svipRedpacket" => array( "title" => language("超级会员红包",[] , $language), "key" => "svipRedpacket", "label" => "label-success" ) );
}
