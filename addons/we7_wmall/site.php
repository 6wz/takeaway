    ...
    public function payResult($params)
    {
        ...
        if( $params["from"] == "return" ) 
        {
            ...
            if( $record["order_type"] == "takeout" && check_plugin_perm("wheel") ) 
            {
                mload()->model("plugin");
                pload()->model("wheel");
                $wheel_url = get_wheel_url(array( "order_id" => $record["order_id"] ));
