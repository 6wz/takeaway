...
function wxapp_urls($type = "wmall")
{
    ...
    if ($type == "wmall") {
        ...
        if (check_plugin_perm('spread')) {
            $data["other"]["spread"] = array("title" => "LL推广", "items" => array(array("title" => "推广中心", "url" => "pages/spread/index")));
        }
        if (check_plugin_perm('ordergrant')) {
            $data["other"]["ordergrant"] = array("title" => "下单有礼", "items" => array(array("title" => "下单有礼", "url" => "package/pages/ordergrant/index")));
        }
        if (check_plugin_perm('shareRedpacket')) {
            $data["other"]["shareRedpacket"] = array("title" => "分享有礼", "items" => array(array("title" => "分享有礼", "url" => "package/pages/shareRedpacket/index")));
        }
        ...
        if (check_plugin_perm('mealRedpacket')) {
            $data["other"]["mealRedpacket"] = array("title" => "套餐红包", "items" => array(array("title" => "套餐红包", "url" => "package/pages/mealRedpacket/meal"), array("title" => "套餐红包Plus", "url" => "package/pages/mealRedpacket/plus")));
        }
        if (check_plugin_perm('freeLunch')) {
            $data["other"]["freelunch"] = array("title" => "霸王餐", "items" => array(array("title" => "霸王餐", "url" => "package/pages/freelunch/index")));
        }
        ...
        if (check_plugin_perm('storebd')) {
            $data["other"]["storebd"] = array("title" => "店铺推广员", "items" => array(array("title" => "推广员入口", "url" => "package/pages/storebd/index")));
        }
        if (check_plugin_perm('gohome')) {
            $data["other"]["gohome"] = array("title" => "生活圈", "items" => array(array("title" => "生活圈首页", "url" => "gohome/pages/home/index"), array("title" => "订单列表", "url" => "gohome/pages/order/index"), array("title" => "我的收藏", "url" => "gohome/pages/member/favorite"), array("title" => "拼团首页", "url" => "gohome/pages/pintuan/index"), array("title" => "限时抢购首页", "url" => "gohome/pages/seckill/index"), array("title" => "砍价首页", "url" => "gohome/pages/kanjia/index"), array("title" => "我的砍价", "url" => "gohome/pages/kanjia/record"), array("title" => "好店首页", "url" => "gohome/pages/haodian/index")));
        ...
        if (check_plugin_perm('svip')) {
            $data["other"]["svip"] = array("title" => "超级会员", "items" => array(array("title" => "超级会员入口", "url" => "package/pages/svip/index"), array("title" => "超级会员个人中心", "url" => "package/pages/svip/mine")));
        }
