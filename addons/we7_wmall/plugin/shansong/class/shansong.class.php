	...
	public function buildParams()
	{
		...
		$params = array(
			...
			'order'     => array(
				...
				'merchant'     => array('id' => $this->config['merchantid'], 'mobile' => $this->config['mobile'], 'name' => $_W['we7_wmall']['config']['mall']['title'], 'token' => $this->config['token']),
				'sender'       => array('mobile' => $this->store['telephone'], 'name' => $sender_name, 'city' => $this->config['city'], 'addr' => $this->store['address'], 'addrDetail' => $this->store['address'], 'lat' => $this->store['location_x'], 'lng' => $this->store['location_y']),
				'receiverList' => array(
					array('mobile' => $this->order['mobile'], 'name' => $this->order['username'], 'city' => $this->config['city'], 'addr' => $this->order['address'], 'addrDetail' => $this->order['address'], 'lat' => $this->order['location_x'], 'lng' => $this->order['location_y'])
					),
				'goods'        => $goods_title,
				'weight'       => 4,
				'addition'     => 0,
