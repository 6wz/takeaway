...
{
	$data = array(
		'kanjia'  => array('text' => '砍价', 'css' => 'label label-danger'),
		'pintuan' => array('text' => '拼团', 'css' => 'label label-info'),
		'seckill' => array('text' => '抢购', 'css' => 'label label-warning')
		);
...
{
	$data = array(
		1 => array('text' => '待付款', 'css' => 'label label-warning'),
		2 => array('text' => '待生效', 'css' => 'label label-warning'),
		3 => array('text' => '待使用', 'css' => 'label label-danger'),
		4 => array('text' => '待收货', 'css' => 'label label-danger'),
		5 => array('text' => '待评价', 'css' => 'label label-danger'),
		6 => array('text' => '已完成', 'css' => 'label label-success'),
		7 => array('text' => '已取消', 'css' => 'label label-default')
		);
...
{
	$data = array(
		array('text' => '下架中', 'css' => 'label label-info'),
		array('text' => '进行中', 'css' => 'label label-success'),
		array('text' => '未开始', 'css' => 'label label-warning'),
		array('text' => '已结束', 'css' => 'label label-danger')
		);
...
function gohome_order_begin_refund($orderOrid)
{
	...
	if ($order['pay_type'] == 'credit') {
		if (0 < $order['uid']) {
			$log = array($order['uid'], $order['order_type_cn'] . '订单退款, 订单号:' . $order['id'] . ', 退款金额:' . $order['final_fee'] . '元', 'we7_wmall');
			mload()->model('member');
	...
	$data = array(
		'goods'      => array(
			1 => array(
				'title' => '很差',
				'tags'  => array(
					array('id' => 0, 'title' => '味道差', 'active' => 0),
					array('id' => 1, 'title' => '服务不好', 'active' => 0),
					array('id' => 2, 'title' => '质量差', 'active' => 0),
					array('id' => 3, 'title' => '包装差', 'active' => 0),
					array('id' => 4, 'title' => '环境差', 'active' => 0),
					array('id' => 5, 'title' => '卫生差', 'active' => 0)
					)
				),
			2 => array(
				'title' => '一般',
				'tags'  => array(
					array('id' => 0, 'title' => '味道一般', 'active' => 0),
					array('id' => 1, 'title' => '服务一般', 'active' => 0),
					array('id' => 2, 'title' => '质量一般', 'active' => 0),
					array('id' => 3, 'title' => '包装一般', 'active' => 0),
					array('id' => 4, 'title' => '环境一般', 'active' => 0),
					array('id' => 5, 'title' => '卫生一般', 'active' => 0)
					)
				),
			3 => array(
				'title' => '满意',
				'tags'  => array(
					array('id' => 0, 'title' => '味道还行', 'active' => 0),
					array('id' => 1, 'title' => '服务还行', 'active' => 0),
					array('id' => 2, 'title' => '质量还行', 'active' => 0),
					array('id' => 3, 'title' => '包装还行', 'active' => 0),
					array('id' => 4, 'title' => '环境还行', 'active' => 0),
					array('id' => 5, 'title' => '卫生还行', 'active' => 0)
					)
				),
			4 => array(
				'title' => '非常满意',
				'tags'  => array(
					array('id' => 0, 'title' => '味道很好', 'active' => 0),
					array('id' => 1, 'title' => '服务很好', 'active' => 0),
					array('id' => 2, 'title' => '质量很好', 'active' => 0),
					array('id' => 3, 'title' => '包装很好', 'active' => 0),
					array('id' => 4, 'title' => '环境很好', 'active' => 0),
					array('id' => 5, 'title' => '卫生很好', 'active' => 0)
					)
				),
			5 => array(
				'title' => '无可挑剔',
				'tags'  => array(
					array('id' => 0, 'title' => '菜品美味', 'active' => 0),
					array('id' => 1, 'title' => '服务周到', 'active' => 0),
					array('id' => 2, 'title' => '干净卫生', 'active' => 0),
					array('id' => 3, 'title' => '态度很好', 'active' => 0),
					array('id' => 4, 'title' => '价格便宜', 'active' => 0),
					array('id' => 5, 'title' => '货品完好', 'active' => 0)
					)
				)
			),
		'deliveryer' => array()
...
function gohome_complain_notice($idOrComplain)
{
	...
	if (!empty($complain)) {
		$complain_types = array(
			'cheat'     => array('type' => 'cheat', 'text' => '网页包含欺诈信息（如：假红包）'),
			'eroticism' => array('type' => 'eroticism', 'text' => '网页包含欺色情信息'),
			'violence'  => array('type' => 'violence', 'text' => '网页包含欺暴力恐怖信息'),
			'politics'  => array('type' => 'politics', 'text' => '网页包含欺政治敏感信息'),
			'privacy'   => array('type' => 'privacy', 'text' => '网页在收集个人隐私信息（如：钓鱼链接）'),
			'induce'    => array('type' => 'induce', 'text' => '网页包含诱导分享/关注性质的内容'),
			'rumor'     => array('type' => 'rumor', 'text' => '网页可能包含谣言信息'),
...
function gohome_get_menu($type = '')
{
	...
	$menus = array(
		'gohome'    => array(
			...
			'data'   => array(
				'M0123456789101' => array('link' => '/gohome/pages/home/index', 'icon' => 'icon-home', 'text' => '首页'),
				'M0123456789102' => array('link' => '/gohome/pages/member/favorite', 'icon' => 'icon-likefill', 'text' => '收藏'),
				'M0123456789103' => array('link' => '/gohome/pages/order/index', 'icon' => 'icon-order', 'text' => '订单'),
				'M0123456789104' => array('link' => '/gohome/pages/tongcheng/index', 'icon' => 'icon-community_fill_light', 'text' => '同城'),
				'M0123456789105' => array('link' => '/pages/member/mine', 'icon' => 'icon-mine', 'text' => '我的')
				)
			),
		'pintuan'   => array(
			'name'   => 'pintuan',
			...
			'css'    => array('iconColor' => '#163636', 'iconColorActive' => '#ff2d4b', 'textColor' => '#929292', 'textColorActive' => '#ff2d4b'),
			'data'   => array(
				'M0123456789101' => array('link' => '/gohome/pages/pintuan/index', 'icon' => 'icon-home', 'text' => '首页'),
				'M0123456789103' => array('link' => '/gohome/pages/member/favorite', 'icon' => 'icon-likefill', 'text' => '收藏'),
				'M0123456789102' => array('link' => '/gohome/pages/order/index', 'icon' => 'icon-order', 'text' => '订单'),
				'M0123456789104' => array('link' => '/gohome/pages/home/index', 'icon' => 'icon-skip', 'text' => '返回生活圈')
				)
			),
		'kanjia'    => array(
			'name'   => 'kanjia',
			...
			'css'    => array('iconColor' => '#163636', 'iconColorActive' => '#ff2d4b', 'textColor' => '#929292', 'textColorActive' => '#ff2d4b'),
			'data'   => array(
				'M0123456789101' => array('link' => '/gohome/pages/kanjia/index', 'icon' => 'icon-home', 'text' => '首页'),
				'M0123456789103' => array('link' => '/gohome/pages/kanjia/record', 'icon' => 'icon-friend', 'text' => '砍价'),
				'M0123456789104' => array('link' => '/gohome/pages/member/favorite', 'icon' => 'icon-likefill', 'text' => '收藏'),
				'M0123456789102' => array('link' => '/gohome/pages/order/index', 'icon' => 'icon-order', 'text' => '订单'),
				'M0123456789105' => array('link' => '/gohome/pages/home/index', 'icon' => 'icon-skip', 'text' => '返回生活圈')
				)
			),
		'seckill'   => array(
			'name'   => 'seckill',
			...
			'css'    => array('iconColor' => '#163636', 'iconColorActive' => '#ff2d4b', 'textColor' => '#929292', 'textColorActive' => '#ff2d4b'),
			'data'   => array(
				'M0123456789101' => array('link' => '/gohome/pages/seckill/index', 'icon' => 'icon-home', 'text' => '首页'),
				'M0123456789102' => array('link' => '/gohome/pages/order/index', 'icon' => 'icon-order', 'text' => '订单'),
				'M0123456789103' => array('link' => '/gohome/pages/member/favorite', 'icon' => 'icon-likefill', 'text' => '收藏'),
				'M0123456789104' => array('link' => '/gohome/pages/home/index', 'icon' => 'icon-skip', 'text' => '返回生活圈')
				)
		...
		'tongcheng' => array(
			...
			'css'    => array('iconColor' => '#163636', 'iconColorActive' => '#ff2d4b', 'textColor' => '#929292', 'textColorActive' => '#ff2d4b'),
			'data'   => array(
				'M0123456789101' => array('link' => '/gohome/pages/tongcheng/index', 'icon' => 'icon-home', 'text' => '首页'),
				'M0123456789102' => array('link' => '/gohome/pages/tongcheng/publish/index', 'icon' => 'icon-edit', 'text' => '发布'),
				'M0123456789103' => array('link' => '/gohome/pages/tongcheng/publish/list', 'icon' => 'icon-message', 'text' => '我的发布'),
				'M0123456789104' => array('link' => '/gohome/pages/home/index', 'icon' => 'icon-skip', 'text' => '返回生活圈')
				)
			),
		'haodian'   => array(
			...
			'css'    => array('iconColor' => '#163636', 'iconColorActive' => '#ff2d4b', 'textColor' => '#929292', 'textColorActive' => '#ff2d4b'),
			'data'   => array(
				'M0123456789101' => array('link' => '/gohome/pages/haodian/index', 'icon' => 'icon-home', 'text' => '首页'),
				'M0123456789103' => array('link' => '/gohome/pages/member/favorite', 'icon' => 'icon-likefill', 'text' => '收藏'),
				'M0123456789104' => array('link' => '/gohome/pages/home/index', 'icon' => 'icon-skip', 'text' => '返回生活圈')
				)
			)
