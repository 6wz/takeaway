...
function pintuan_is_available($goodsOrId, $team_id = 0)
{
    ...
    if (0 < $team_id) {
        $condition = " where uniacid = :uniacid and agentid = :agentid and order_type = :order_type and goods_id = :goods_id and team_id = :team_id and status = 2";
        $params = array(":uniacid" => $_W["uniacid"], ":agentid" => $_W["agentid"], ":order_type" => "pintuan", ":goods_id" => $goods["id"], ":team_id" => $team_id);
