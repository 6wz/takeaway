...
if ($op == 'index') {
	...
	$_W['_share'] = array('title' => $config_bargain['share']['title'], 'desc' => $config_bargain['share']['desc'], 'imgUrl' => tomedia($config_bargain['share']['imgUrl']), 'link' => !empty($config_bargain['share']['desc']) ? $config_bargain['share']['desc'] : ivurl('/pages/bargain/index', array(), true));
