        ...
        if ($type == "delivery_wait") {
            ...
            if ($type == "cancel") {
                ...
                if ($type == "direct_transfer") {
                    ...
                    $remark = array("下单时间: " . date("Y-m-d H:i", $order["addtime"]), "转单时间: " . date("Y-m-d H:i", TIMESTAMP), "小　　费: " . $order["delivery_tips"] . "元", "收货　人: " . $order["accept_username"], "联系手机: " . $order["accept_mobile"], "送货地址: " . $order["accept_address"], "订单类型: " . $order["order_type_cn"]);
                    $remark = implode("\n", $remark);
                    ...
                    if ($type == "direct_transfer_refuse") {
                        ...
                        $remark = array("下单时间: " . date("Y-m-d H:i", $order["addtime"]), "收货　人: " . $order["accept_username"], "联系手机: " . $order["accept_mobile"], "送货地址: " . $order["accept_address"], "订单类型: " . $order["order_type_cn"]);
                        $remark = implode("\n", $remark);
                        $url = imurl("delivery/order/errander/list", array("status" => $order["delivery_status"]), true);
                    }
                }
