...
if ($op == 'create') {
	...
	$data = array(
		'uniacid'              => $_W['uniacid'],
		'agentid'              => $category['diypage']['agentid'],
		'acid'                 => $_W['acid'],
		'uid'                  => $_W['member']['uid'],
		'openid'               => $_W['openid'],
		'code'                 => random(4, true),
		'order_sn'             => date('YmdHis') . random(6, true),
		'order_type'           => $diypage['data']['page']['scene'],
		'order_cid'            => $id,
		'buy_username'         => $buyaddress['realname'],
		'buy_mobile'           => $buyaddress['mobile'],
		'buy_sex'              => $buyaddress['sex'],
		'buy_address'          => $buyaddress['address'] . $buyaddress['number'],
		'buy_location_x'       => $buyaddress['location_x'],
		'buy_location_y'       => $buyaddress['location_y'],
		'accept_mobile'        => $acceptaddress['mobile'],
		'accept_username'      => $acceptaddress['realname'],
		'accept_sex'           => $acceptaddress['sex'],
		'accept_address'       => $acceptaddress['address'] . $acceptaddress['number'],
		'accept_location_x'    => $acceptaddress['location_x'],
		'accept_location_y'    => $acceptaddress['location_y'],
		'distance'             => $order['distance'],
		'delivery_time'        => $order['delivery_time_cn'],
		'goods_name'           => $order['note'],
		'goods_price'          => $order['goods_price'],
		'goods_weight'         => trim($order['goods_weight']),
		'note'                 => $order['note'],
		'data'                 => array('order' => $required, 'fees' => $order['data']['fees'], 'version' => 'version_diy'),
		'delivery_fee'         => $order['delivery_fee'],
		'delivery_tips'        => floatval($order['delivery_tips']),
