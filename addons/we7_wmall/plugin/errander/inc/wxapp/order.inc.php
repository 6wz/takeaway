...
if ($op == "detail") {
    ...
    $result = array("order" => $order, "deliveryer" => $deliveryer, "log" => $log, "logs" => $logs, "maxid" => $maxid, "minid" => $minid, "refund_logs" => $refund_logs, "refundmaxid" => $refundmaxid, "show_location" => $show_location);
