...
if ($op == 'list') {
	...
	if ($export == 1) {
		$order_fields = array(
			'id'                   => array('field' => 'id', 'title' => '订单ID', 'width' => '10'),
			'order_sn'             => array('field' => 'order_sn', 'title' => '订单编号', 'width' => '30'),
			'uid'                  => array('field' => 'uid', 'title' => '下单人UID', 'width' => '10'),
			'openid'               => array('field' => 'openid', 'title' => '粉丝openid', 'width' => '40'),
			'order_type'           => array('field' => 'order_type', 'title' => '订单类型', 'width' => '20'),
			'goods_name'           => array('field' => 'goods_name', 'title' => '商品名称', 'width' => '40'),
			'goods_price'          => array('field' => 'goods_price', 'title' => '商品预期价格', 'width' => '30'),
			'final_fee'            => array('field' => 'final_fee', 'title' => '顾客支付', 'width' => '30'),
			'delivery_tips'        => array('field' => 'delivery_tips', 'title' => '小费', 'width' => '30'),
			'goods_weight'         => array('field' => 'goods_weight', 'title' => '商品重量', 'width' => '20'),
			'buy_username'         => array('field' => 'buy_username', 'title' => '发货人姓名', 'width' => '30'),
			'buy_sex'              => array('field' => 'buy_sex', 'title' => '发货人性别', 'width' => '30'),
			'buy_mobile'           => array('field' => 'buy_mobile', 'title' => '发货人手机号', 'width' => '30'),
			'buy_address'          => array('field' => 'buy_address', 'title' => '发货地址', 'width' => '40'),
			'accept_username'      => array('field' => 'accept_username', 'title' => '收货人姓名', 'width' => '30'),
			'accept_sex'           => array('field' => 'accept_sex', 'title' => '收货人性别', 'width' => '30'),
			'accept_mobile'        => array('field' => 'accept_mobile', 'title' => '收货人手机号', 'width' => '30'),
			'accept_address'       => array('field' => 'accept_address', 'title' => '收货地址', 'width' => '40'),
			'pay_type'             => array('field' => 'pay_type', 'title' => '支付方式', 'width' => '15'),
			'addtime'              => array('field' => 'addtime', 'title' => '下单时间', 'width' => '25'),
			'out_trade_no'         => array('field' => 'out_trade_no', 'title' => '本平台支付单号', 'width' => '25'),
			'transaction_id'       => array('field' => 'transaction_id', 'title' => '第三方支付单号', 'width' => '25'),
			'status'               => array('field' => 'status', 'title' => '订单状态', 'width' => '25'),
			'status_cn'            => array('field' => 'status_cn', 'title' => '订单最新进度', 'width' => '25'),
			'deliveryer_id'        => array('field' => 'deliveryer_id', 'title' => '配送员', 'width' => '25'),
			'delivery_assign_time' => array('field' => 'delivery_assign_time', 'title' => '最后抢单时间', 'width' => '25'),
			'distance'             => array('field' => 'distance', 'title' => '配送距离', 'width' => '25')
			);
