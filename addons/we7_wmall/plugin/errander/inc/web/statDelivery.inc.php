...
if ($op == 'index') {
	$_W['page']['title'] = '配送统计';
	$deliveryers = deliveryer_fetchall(0, array('work_status' => -1, 'agentid' => -1, 'order_type' => 'is_errander'));
	...
	$records_before = pdo_fetchall('SELECT
	 ...
	 FROM ' . tablename('tiny_wmall_errander_order') . (' ' . $condition_before . ' group by stat_day'), $params, 'stat_day');
	$records = array();
	$basic = array('stat_day' => 0, 'total_success_order' => 0, 'total_timeout_order' => 0, 'total_before_order' => 0, 'avg_delivery_time' => 0, 'avg_normal_delivery_time' => 0, 'percent_normal' => 0, 'percent_timeout' => 0, 'avg_delivery_notify_time' => 0, 'avg_delivery_instore_time' => 0, 'avg_delivery_success_time' => 0);
	$i = $endtime;
...
if ($op == 'day') {
	...
	$records = array();
	$basic = array('id' => 0, 'total_success_order' => 0, 'total_timeout_order' => 0, 'total_normal_order' => 0, 'total_before_order' => 0, 'avg_delivery_time' => 0, 'avg_normal_delivery_time' => 0, 'percent_normal' => 0, 'percent_timeout' => 0, 'avg_delivery_notify_time' => 0, 'avg_delivery_instore_time' => 0, 'avg_delivery_success_time' => 0);
	$records = array();
	$deliveryers = deliveryer_fetchall(0, array('work_status' => -1, 'agentid' => -1, 'order_type' => 'is_errander'));
