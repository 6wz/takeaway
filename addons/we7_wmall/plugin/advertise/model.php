...
function advertise_get_types()
{
	$advertise_types = array(
		'stick'            => array('text' => '商家列表置顶', 'value' => 'stick'),
		'recommendHome'    => array('text' => '为您优选首页', 'value' => 'recommendHome'),
		'recommendOther'   => array('text' => '为您优选更多页', 'value' => 'recommendOther'),
		'slideHomeTop'     => array('text' => '平台首页幻灯片', 'value' => 'slideHomeTop'),
		'slideOrderDetail' => array('text' => '订单详情页幻灯片', 'value' => 'slideOrderDetail'),
		'slidePaycenter'   => array('text' => '收银台页幻灯片', 'value' => 'slidePaycenter'),
		'slideMember'      => array('text' => '会员中心幻灯片', 'value' => 'slideMember')
		);
	...
	if (!empty($trades)) {
		...
		foreach ($trades as $trade) {
			...
			if (in_array($trade['type'], array_keys($routers))) {
				...
				else if ($trade['type'] == 'recommendHome') {
