...
if ($op == 'set') {
	...
	if ($_W['ispost']) {
		...
		if ($form_type == 'extra') {
			...
			$fee = array('fee_takeout' => $fee_takeout, 'fee_instore' => $fee_instore, 'fee_errander' => $fee_errander, 'fee_period' => $fee_period, 'fee_gohome' => $gohome);
