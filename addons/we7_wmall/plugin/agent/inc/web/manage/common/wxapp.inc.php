...
if ($op == 'link') {
	...
	'title' => '小程序链接',
	'items' => array(
		array('title' => '平台首页', 'url' => 'pages/home/index'),
		array('title' => '搜索商家', 'url' => 'pages/home/search'),
		array('title' => '会员中心', 'url' => 'pages/member/mine'),
		array('title' => '我的订单', 'url' => 'pages/order/index'),
		array('title' => '我的代金券', 'url' => 'pages/member/coupon/index'),
		array('title' => '我的收货地址', 'url' => 'pages/member/address'),
		array('title' => '我的收藏', 'url' => 'pages/member/favorite'),
		array('title' => '配送会员卡', 'url' => 'pages/deliveryCard/index'),
		array('title' => '领券中心', 'url' => 'pages/channel/coupon'),
		array('title' => '余额充值', 'url' => 'pages/member/recharge'),
		array('title' => '天天特价', 'url' => 'pages/channel/bargain')
		)
	);
	...
	array(
		'title' => '平台链接',
		'items' => array(
			array('title' => '跑腿首页', 'url' => 'pages/errander/index'),
			array('title' => '跑腿订单', 'url' => 'pages/errander/order')
			)
		)
	);
	...
	array(
		'title' => 'LL推广',
		'items' => array(
			array('title' => '推广中心', 'url' => 'pages/spread/index')
			)
		)
	);
	}
	...
	array(
		'title' => '下单有礼',
		'items' => array(
			array('title' => '下单有礼', 'url' => 'package/pages/ordergrant/index')
			)
		)
	);
	}
