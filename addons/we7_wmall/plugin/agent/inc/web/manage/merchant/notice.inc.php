...
if ($op == 'list') {
	...
	$notices = pdo_fetchall('select * from' . tablename('tiny_wmall_notice') . 'where uniacid = :uniacid and agentid = :agentid and type = :type order by displayorder desc', array(':uniacid' => $_W['uniacid'], ':agentid' => $_W['agentid'], ':type' => 'store'));
}
