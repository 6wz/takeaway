...
if( $ta == "index" ) 
{
    ...
    $records_cancel = pdo_fetchall("select count(*) as total_cancel_order, sid from " . tablename("tiny_wmall_order") . $condition . " group by sid order by total_cancel_order desc", $params);
    if( !empty($records) ) 
    {
