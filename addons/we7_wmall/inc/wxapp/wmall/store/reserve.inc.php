...
else
{
    if( $ta == "post" ) 
    {
        ...
        if( empty($tables) ) 
        {
            imessage(error(-1, "该桌台类型下没有可以预订的桌位"), "", "ajax");
        }
        ...
        if( !empty($reserve_orders) ) 
        {
            ...
            foreach( $tables as &$table ) 
            {
                ...
                {
                    $table["is_reserved"] = 1;
                    $table["title"] = (string) $table["title"] . "(已预订)";
                }
        ...
        $result = array( "store" => $store, "coupons" => $coupons, "category" => $category, "tables" => $tables, "order" => $order, "cart" => $cart, "columns" => array( "1人", "2人", "3人", "4人", "5人", "6人", "7人", "8人", "9人", "10人", "11人", "12人", "13人", "14人", "15人", "16人", "17人", "18人", "19人", "20人" ), "islegal" => true );
        imessage(error(0, $result), "", "ajax");
    }
    else
    {
