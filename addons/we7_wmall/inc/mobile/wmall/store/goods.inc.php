...
if( $ta == "index" )
{
    ...
    $categorys = chooseLanguageData($result["category"] , ['title' , 'description']);

    foreach ($result['cate_goods'] as $k=>$cg) {

        $result['cate_goods'][$k] = chooseLanguageData($cg , ['title' , 'unitname','label' ,'content' ,'description' , 'attrs','unitname_cn']) ;
    }
