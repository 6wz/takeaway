...
if( check_plugin_perm("spread") )
{
    ...
    {
        $urls["spread"] = array( "title" => $config_spread["menu_name"], "url" => imurl("spread/index"), "css" => "active", "icon" => "mypage_share.png" );
    }
