...
"epayment"=>array(
   'on'=>$_GPC["otherpay"]["epayment"]["on"],
   'appid'=>$_GPC["otherpay"]["epayment"]["appid"],
   'mch_store_id'=>$_GPC["otherpay"]["epayment"]["mch_store_id"],
   'authentication_code'=>$_GPC["otherpay"]["epayment"]["authentication_code"],
   'bz'=>$_GPC["otherpay"]["epayment"]["bz"], 
),
"suppay"=>array(
   'on'=>$_GPC["otherpay"]["suppay"]["on"],
   'appid'=>$_GPC["otherpay"]["suppay"]["appid"],
   'mchId'=>$_GPC["otherpay"]["suppay"]["mchId"],
   'md5Key'=>$_GPC["otherpay"]["suppay"]["md5Key"],
   'bz'=>$_GPC["otherpay"]["suppay"]["bz"], 
),
"stripe"=>array(
   'on'=>$_GPC["otherpay"]["stripe"]["on"],
   'pk'=>$_GPC["otherpay"]["stripe"]["pk"],
   'sk'=>$_GPC["otherpay"]["stripe"]["sk"],
   'bz'=>$_GPC["otherpay"]["stripe"]["bz"]
),
"attract"=>array(
   'on'=>$_GPC["otherpay"]["attract"]["on"],
   'appid'=>$_GPC["otherpay"]["attract"]["appid"],
   'mch_store_id'=>$_GPC["otherpay"]["attract"]["mch_store_id"],
   'authentication_code'=>$_GPC["otherpay"]["attract"]["authentication_code"],
   'bz'=>$_GPC["otherpay"]["attract"]["bz"], 
)
);
...
if( $op == "getcash" ) 
{
    ...
    if( $_W["ispost"] ) 
    {
        $getcash = array( "channel" => $_GPC["getcash_channel"], "type" => $_GPC["getcash_type"] );
