		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a href="https://33f3.cn">拾光官网</a></li>
					<li role="presentation"><a href="https://33f3.cn">拾光论坛</a></li>
				</ul>
				<img src="?res=logo" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="http://www.jooyv.com">倪蜀网络</a> &nbsp; &nbsp; <a href="http://www.jooyv.com">倪蜀网络</a> &nbsp; &nbsp; <a href="http://www.jooyv.com">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a href="http://www.jooyv.com"><b>倪蜀网络</b></a>  &copy; 2018 <a href="http://www.jooyv.com">www.jooyv.com</a>
				</div>
			</div>
		</div>
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<label class="radio-inline">
							<a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=5aa0840234c487a5368833f19eea4130cbac053133d2f0a8de359cbd23b86d0f"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="拾光微擎模块交流" title="拾光微擎模块交流"></a>
						</label>
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“拾光微擎”系统，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php">访问网站首页</a>
	</div>
