...
<div class="nav slimscroll">
	<?php  if(check_perm('merchant.store') || check_perm('merchant.account') || check_perm('merchant.activity')) { ?>
		...
		<ul class="menu-item">
			...
			<?php  } ?>
			<?php  if(check_perm('merchant.activity')) { ?>
				<li <?php  if($_W['_action'] == 'activity' && $_W['op'] == 'index') { ?>class="active"<?php  } ?>>
					<a href="<?php  echo iurl('merchant/activity/index');?>">商户活动</a>
				</li>
				<li <?php  if($_W['_action'] == 'activity' && $_W['op'] == 'index') { ?>class="active"<?php  } ?>>
					<a href="<?php  echo iurl('merchant/activity/displayorder');?>">活动展示排序</a>
				</li>
			<?php  } ?>
		</ul>
	<?php  } ?>
	...
	<?php  } ?>
	<?php  if(check_perm('merchant.settle') || check_perm('merchant.storage')) { ?>
		...
		<ul class="menu-item">
			...
			<?php  } ?>
			<?php  if(check_perm('merchant.storage')) { ?>
				<li <?php  if($_W['_action'] == 'storage') { ?>class="active"<?php  } ?>>
					<a href="<?php  echo iurl('merchant/storage/list');?>">商家回收站</a>
				</li>
			<?php  } ?>
		</ul>
	<?php  } ?>
