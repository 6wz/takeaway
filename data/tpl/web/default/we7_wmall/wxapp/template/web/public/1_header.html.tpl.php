			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					<a href="javascript:;" class="dropdown-toggle account-info" data-toggle="dropdown">
						...
						<?php  echo $_W['account']['name'];?>(uniacid:<?php  echo $_W['uniacid'];?>) <span class="caret"></span>
					</a>
			...
			<div class="pull-right user-section">
				<div class="pull-left wm-user-name">
					<a href="javascript:;" class="text">
						<span class="names"><?php  echo $_W['role_cn'];?></span>
						<span><i class="fa fa-trans fa-angle-down"></i></span>
					</a>
					<?php  if($_W['role'] == 'founder') { ?>
					<ul class="drop-menu">
						<li class="page-jump"><a href="<?php  echo url('user/profile')?>">修改密码</a></li>
						<li class="page-jump"><a href="<?php  echo url('user/logout')?>">退出</a></li>
					</ul>
					<?php  } else if($_W['role'] == 'manager') { ?>
					<ul class="drop-menu">
						<li class="page-jump"><a href="<?php  echo url('user/profile')?>">修改密码</a></li>
						<li class="page-jump"><a href="<?php  echo url('user/logout')?>">退出</a></li>
					</ul>
					<?php  } else if($_W['role'] == 'agenter') { ?>
					<ul class="drop-menu">
						<li class="page-jump"><a href="<?php  echo iurl('agent/setting', array('agent' => 1))?>">修改密码</a></li>
						<li class="page-jump"><a href="<?php  echo iurl('agent/loginout', array('agent' => 1))?>">退出</a></li>
					</ul>
					<?php  } else if($_W['role'] == 'agent_operator') { ?>
					<ul class="drop-menu">
						<li class="page-jump"><a href="<?php  echo iurl('agent/setting', array('agent' => 1))?>">修改密码</a></li>
						<li class="page-jump"><a href="<?php  echo iurl('agent/loginout', array('agent' => 1))?>">退出</a></li>
					</ul>
		...
		<div id="app-third-sidebar" class="clearfix">
			...
			<div class="pull-right user-section">
				<div class="pull-left wm-user-name">
					...
					<?php  } else if($_W['role'] == 'merchanter') { ?>
						<ul class="drop-menu">
